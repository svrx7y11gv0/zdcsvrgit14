...
<style>
    #reportrange
    {
        border-radius: 4px;
									...
									<div class="clearfix">
										<h3 class="content-title pull-left">Out-Time Statistics</h3>
									</div>
									<div class="description">View out-time statistics of any student of any class</div>
								</div>
							</div>
						</div>
						<!-- /PAGE HEADER -->
								...
								<div class="row">
									<div class="col-md-12">
										...
										<div class="box border green">
											<div class="box-title">
												<h4><i class="fa fa-bars"></i>Out-Time Statistics</h4>
											...
											<div class="box-body big">
												<form class="form-horizontal" id="outtime_stats_form" name="outtime_stats_form" method="post" action="<?php echo base_url('secure/outtime_stats');?>">
													<div class="row">
														 <div class="col-md-12">
                                                                                                                    <div class="stats-box form-group hide">
                                                                                                                            <figure class="chart" id="outtime_chart" style="min-width:250px"></figure>
                                                                                                                    </div>
                                                                                                                             ...
                                                                                                                             <select id="student_bioid" name="thisbioid" data-placeholder="Select Student Name" class="form-control">
                                                                                                                                 <?php if(isset($students)):?>
                                                                                                                                     <?php foreach($students as $student):?>
                                                                                                                                         <option value="<?php echo $student['bioid'];?>"> <?php if($student['rollno']!=0 && $student['rollno']!=null) echo $student['rollno']." - "; echo ucfirst($student['firstname'])." ".ucfirst($student['middlename'])." ".ucfirst($student['lastname']); ?></option>
                                                                                                                                     <?php endforeach;?>
                                                                                                                                 <?php endif; ?>
                                                                                                                             </select>
                                                                                                                         </div>
            ...
            jQuery(document).ready(function(){
                ...
                jQuery( "#select_department" ).change(function() {
                 ...
                 jQuery("#btn_show_stats").click(function()
                 {
                     ...
                     {
                         var XaxisType = jQuery('input[name=XaxisType]:checked', '#outtime_stats_form').val();
                         var dataString = "class_code="+jQuery("#class_code").val()+"&bio_id="+jQuery("#student_bioid").val()+"&date_from="+date_from+"&date_to="+date_to;
                         var url = "<?php echo base_url('secure/get_outtime_ofa_student');?>";
                                jQuery.ajax({
                                     type: "POST",
                                     url: url,
                                     data: dataString, // serializes the form's elements.
                                     ...
                                     success: function(data)
                                     {
                                        ...
                                        else
                                        {
                                            ...
                                            /*********************** CHART GENERATION ************************/
                                                        ...
                                                        var myChart = new xChart('line-dotted', data, '#outtime_chart', opts);
