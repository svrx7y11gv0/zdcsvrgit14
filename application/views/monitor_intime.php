...
<link rel="stylesheet" type="text/css" href="<?php echo base_url('resources/js/datatables/extras/TableTools/media/css/TableTools.min.css');?>" />
									...
									<div class="description">Monitor in-time of students class wise</div>
								</div>
							</div>
						</div>
						<!-- /PAGE HEADER -->
								...
								<div class="row">
									<div class="col-md-12">
										...
										<div class="box border green">
											<div class="box-title">
												<h4><i class="fa fa-bars"></i>Monitor In-Time</h4>
											...
											<div class="box-body big">
												<form class="form-horizontal" id="monitor_intime_form" name="monitor_intime_form" method="post" action="<?php echo base_url('secure/monitor_intime');?>">
													<div class="row">
														 <div class="col-md-12">
                                                                                            ...
                                                                                            <div class="row">
                                                                                            <div class="col-md-12">
                                                                                                <?php if(isset($students_intime_details)):?>
                                                                                                    <table id="datatable1" cellpadding="0" cellspacing="0" border="0" class="datatable table table-striped table-bordered table-hover">
                                                                                                        ...
                                                                                                        <tbody>
                                                                                                            <?php foreach($students_intime_details as $detail):?>
                                                                                                                <tr>
            ...
            jQuery(document).ready(function(){
				...
				"sPaginationType": "bs_full"
                 ...
                 $( "#btn_show_records" ).click(function() {
                    ...
                    if(error_flag==0)
                    {
                        jQuery("#monitor_intime_form").submit();
                    }
                    else
                        App.unblockUI(el);
                });
