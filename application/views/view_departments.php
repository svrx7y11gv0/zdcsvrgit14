									...
									<div class="col-md-12">
										...
										<div class="box border lite">
											...
											<div class="box-body big">
												...
												<form class="form-horizontal" id="department_form" name="department_form" method="post" action="<?php echo base_url('secure/get_department_details');?>">
                                                                                                    <div class="row">
                                                                                                        <div class="col-md-12">
                                                                                                               <div class="col-md-12">
                                                                                                                   <div class="form-group">
                                                                                                                       ...
                                                                                                                       <div class="col-md-10">
                                                                                                                           <select id="select_department" name="select_department" data-placeholder="Choose Department..." class="form-control">
                                                                                                                               <?php if(isset($departments)):?>
                                                                                                ...
                                                                                                <div class="dept_classes">
                                                                                                    <table id="dept_classes_tab">
                                                                                                        <thead>
                                                                                                          <tr>
                                                                                                                <th colspan="5" class="{sorter: true}">Classes under <?php echo $departments[0]['department_name'];?> department</th>
                                                                                                          </tr>
                                                                                                          <tr>
                                                                                                                <th>Class Code</th>
                                                                                                        ...
                                                                                                        <tbody>
                                                                                                            ...
                                                                                                            <?php foreach($department_classes as $department_class):?>
                                                                                                                <tr class="<?php if($i%2==0) echo 'ss_tr_even';?>">
                                                                                                                    ...
                                                                                                                    <td><?php echo $department_class['device_platform'];?></td>
                                                                                                                </tr>
                                                                                                                <?php $i++;?>
                                                                                                            <?php endforeach;?>
                                                                                                        </tbody>
                                                                                                ...
                                                                                                <div class="dept_teachers">
                                                                                                    <table id="dept_teachers_tab">
                                                                                                        <thead>
                                                                                                          <tr>
                                                                                                                <th colspan="5" class="{sorter: true}">Teachers under <?php echo $departments[0]['department_name'];?> department</th>
                                                                                                          </tr>
                                                                                                          <tr>
                                                                                                                <th>First Name</th>
